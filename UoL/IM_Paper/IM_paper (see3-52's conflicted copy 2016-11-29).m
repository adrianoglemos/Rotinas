...
JAK1_pt_trend=mdl_pt_JAK1.Coefficients(2,1);

mdl_pt_JAK2 = fitlm([1:length(pt_JAK2)],pt_JAK2);
JAK2_pt_trend=mdl_pt_JAK2.Coefficients(2,1)

mdl_pt_JAK3 = fitlm([1:length(pt_JAK3)],pt_JAK3);
JAK3_pt_trend=mdl_pt_JAK3.Coefficients(2,1)
...
plot([1:length(pt_JAK1)],mdl_pt_JAK1.Fitted,'b');
plot([1:length(pt_JAK2)],mdl_pt_JAK2.Fitted,'k');
plot([1:length(pt_JAK3)],mdl_pt_JAK3.Fitted,'r');
...
PG1_pt_trend=mdl_pt_PG1.Coefficients(2,1)

mdl_pt_PG2 = fitlm([1:length(pt_PG2)],pt_PG2/1000);
PG2_pt_trend=mdl_pt_PG2.Coefficients(2,1)

mdl_pt_PG3 = fitlm([1:length(pt_PG3)],pt_PG3/1000);
PG3_pt_trend=mdl_pt_PG3.Coefficients(2,1)
...
plot([1:length(pt_PG1)],mdl_pt_PG1.Fitted,'b');
plot([1:length(pt_PG2)],mdl_pt_PG2.Fitted,'k');
plot([1:length(pt_PG3)],mdl_pt_PG3.Fitted,'r');
...
FJ1_pt_trend=mdl_pt_FJ1.Coefficients(2,1)

mdl_pt_FJ2 = fitlm([1:length(pt_FJ2)],pt_FJ2/1000);
FJ2_pt_trend=mdl_pt_FJ2.Coefficients(2,1)

mdl_pt_FJ3 = fitlm([1:length(pt_FJ3)],pt_FJ3/1000);
FJ3_pt_trend=mdl_pt_FJ3.Coefficients(2,1)
...
plot([1:length(pt_FJ1)],mdl_pt_FJ1.Fitted,'b');
plot([1:length(pt_FJ2)],mdl_pt_FJ2.Fitted,'k');
plot([1:length(pt_FJ3)],mdl_pt_FJ3.Fitted,'r');
