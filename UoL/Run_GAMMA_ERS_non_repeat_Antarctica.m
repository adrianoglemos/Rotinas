...
data1= num2str(20100211); data2= num2str(20100227);
path1=['/nfs/a59/eeagdl/Data/Tests/NTrack/Images/New_ERS/Antarctic/438/ERS2_438_77446_5157_100211_122406/'];
path2=['/nfs/a59/eeagdl/Data/Tests/NTrack/Images/New_ERS/Antarctic/166/ERS2_166_77675_5157_100227_122106/'];

cd /nfs/a59/eeagdl/Data/Tests/NTrack/Images/New_ERS/Antarctic/438/ERS2_438_77446_5157_100211_122406/
...
eval(['!gc_map ' path1 data1 '.mli.par - /nfs/a59/eeagdl/Data/Available_Images/S1/Antarctic/DEM/Bamber_1km/nsidc0422_antarctic_1km_dem/krigged_dem_nsidc.bin.par /nfs/a59/eeagdl/Data/Available_Images/S1/Antarctic/DEM/Bamber_1km/nsidc0422_antarctic_1km_dem/krigged_dem_nsidc.bin.swap ' data1 '.dem.par ' data1 '.dem ' data1 '.lt 100 100 ' data1 '.sim_sar u_' data1 ' v_' data1 ' inc_' data1 ' psi_' data1 ' pix_' data1 ' ls_map_' data1 ' 8 1']);
...
eval(['!offset_pwrm mli0 ' path2 data2 '.mli diff0 offs0 snr0 256 256 offsets0 2 16 16 3']);
eval(['!offset_fitm offs0 snr0 diff0 coffs0 coffsets0 3 4']);
...
eval(['mkdir /nfs/a59/eeagdl/Data/Tests/NTrack/Processing/Antarctica/' data1 '_' data2 '/']);
cd(['/nfs/a59/eeagdl/Data/Tests/NTrack/Processing/Antarctica/' data1 '_' data2 '/'])

eval(['!create_offset ' path1 data1 '.slc.par ' path2 data2 '.rslc.par ' data1 '_' data2 '.off 1 - - 0']);
eval(['!offset_pwr ' path1 data1 '.slc ' path2 data2 '.rslc ' path1 data1 '.slc.par ' path2 data2 '.rslc.par ' data1 '_' data2 '.off ' data1 '_' data2 '_offsM ' data1 '_' data2 '_snrM 256 256 ' data1 '_' data2 '_offsetsM 2 128 128 4'])
...
eval(['!offset_tracking ' data1 '_' data2 '_offsNN ' data1 '_' data2 '_snrNN ' path1 data1 '.slc.par ' data1 '_' data2 '.off ' data1 '_' data2 '.disp_map ' data1 '_' data2 '.disp_val 2 5. 1']);
...
eval(['!float_math squRo - VELOCITY ' width ' 3 - - - - 16'])
...
eval(['!gc_map master_' data1 '_' data2 '.mli.par - /nfs/a59/eeagdl/Data/Available_Images/S1/Antarctic/DEM/Bamber_1km/nsidc0422_antarctic_1km_dem/krigged_dem_nsidc.bin.par /nfs/a59/eeagdl/Data/Available_Images/S1/Antarctic/DEM/Bamber_1km/nsidc0422_antarctic_1km_dem/krigged_dem_nsidc.bin.swap ' data1 '.demMaster.par ' data1 '.demMaster ' data1 '.ltMaster 10 10 ' data1 '.sim_sarMaster uMaster_' data1 ' vMaster_' data1 ' incMaster_' data1 ' psiMaster_' data1 ' pixMaster_' data1 ' lsMaster_map_' data1 ' 8 1']);
