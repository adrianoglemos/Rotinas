...
%% Terra SAR Joughin 2016

cd /nfs/a59/eeagdl/DATABASE/GREENLAND/Joughin_Data_GRIS/TerraSAR_X/W69_10N


pathsate_Terra=['/nfs/a59/eeagdl/DATABASE/GREENLAND/Joughin_Data_GRIS/TerraSAR_X/W69_10N/'];
d_Terra=dir(pathsate_Terra);
j=1;
for i=3:length(d_Terra);
    name_Terra=d_Terra(i,1).name;
    data_Terra{j,1}=cellstr(name_Terra);
    %date{j,1}=cellstr(name(18:25));
    list_Terra(j,1)=cellstr(data_Terra{j,1});
    j=j+1;
%folder=char(folder, data);
end
clear d_Terra i j name_Terra
