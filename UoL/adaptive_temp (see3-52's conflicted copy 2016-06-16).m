...
eval(['!multi_look ' data1 '.slc.deramp ' data1 '.slc.deramp.par aDW3_256master_deramp.mli aDW3_256master_deramp.mli.par 30 10']);%Jak
...
ylim(gca,[0 18000]);
        ...
        grid on;
        title('adaptive script 128X128 50X15', 'FontWeight','bold','FontSize',10)
